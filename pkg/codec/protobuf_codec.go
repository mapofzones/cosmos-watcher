...
import (
	...
	kyve "github.com/KYVENetwork/chain/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	kyveRegisterInterfaces(interfaceRegistry)
...
func kyveRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	kyve.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
