...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	rizonRegisterInterfaces(interfaceRegistry)
...
func rizonRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	rizonapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
