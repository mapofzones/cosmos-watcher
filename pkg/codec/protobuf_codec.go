...
import (
	...
	sommelierapp "github.com/peggyjv/sommelier/v6/app"
)

func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	impls := getMessageImplementations()
	interfaceRegistry.RegisterImplementations((*cosmostypes.Msg)(nil), impls...)
	sommelierRegisterInterfaces(interfaceRegistry)
	registerTypes(interfaceRegistry)
}

func sommelierRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	sommelierapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
