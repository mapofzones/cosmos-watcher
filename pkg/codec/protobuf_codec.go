...
import (
	...
	firmaChain "github.com/firmachain/firmachain/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	firmaChainRegisterInterfaces(interfaceRegistry)
...
func firmaChainRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	firmaChain.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
