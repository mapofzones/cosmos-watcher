...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	decentrRegisterInterfaces(interfaceRegistry)
...
func decentrRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	decentrapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
