...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	chihuahuaRegisterInterfaces(interfaceRegistry)
	registerTypes(interfaceRegistry)
}

func chihuahuaRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	chihuahuaapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
