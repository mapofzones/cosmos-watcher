...
import (
	...
	microtickapp "github.com/microtick/mtzone/app"
)

func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	impls := getMessageImplementations()
	interfaceRegistry.RegisterImplementations((*cosmostypes.Msg)(nil), impls...)
	microtickRegisterInterfaces(interfaceRegistry)
	registerTypes(interfaceRegistry)
}

func microtickRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	microtickapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
