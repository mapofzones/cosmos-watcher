...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	omniflixRegisterInterfaces(interfaceRegistry)
...
func omniflixRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	omniflixapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
