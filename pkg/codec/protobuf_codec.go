...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	teritoriRegisterInterfaces(interfaceRegistry)
...
func teritoriRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	teritori.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
