...
import (
	...
	bluzelle "github.com/bluzelle/bluzelle-public/curium/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	bluzelleRegisterInterfaces(interfaceRegistry)
...
func bluzelleRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	bluzelle.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
