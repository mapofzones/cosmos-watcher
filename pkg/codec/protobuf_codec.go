...
import (
	...
	uptick "github.com/UptickNetwork/uptick/app"
	ethermintcryptocodec "github.com/evmos/ethermint/crypto/codec"
)

const (
	AccountAddressPrefix = "uptick"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	uptickRegisterInterfaces(interfaceRegistry)
...
func uptickRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	uptick.ModuleBasics.RegisterInterfaces(interfaceRegistry)
