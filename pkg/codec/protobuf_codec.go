...
import (
	...
	starnameapp "github.com/iov-one/starnamed/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	starnameRegisterInterfaces(interfaceRegistry)
...
func starnameRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	starnameapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
