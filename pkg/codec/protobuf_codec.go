...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	nobleRegisterInterfaces(interfaceRegistry)
...
func nobleRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	nobleapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
