...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	stargazeRegisterInterfaces(interfaceRegistry)
	registerTypes(interfaceRegistry)
}

func stargazeRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	stargazeapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
