...
import (
	...
	konstellationapp "github.com/konstellation/konstellation/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	konstellationRegisterInterfaces(interfaceRegistry)
...
func konstellationRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	konstellationapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
