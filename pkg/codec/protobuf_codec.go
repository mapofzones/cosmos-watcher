...
import (
	...
	secretapp "github.com/scrtlabs/SecretNetwork/app"
)

const (
	AccountAddressPrefix = "secret"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	secretRegisterInterfaces(interfaceRegistry)
...
func secretRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	secretapp.ModuleBasics().RegisterInterfaces(interfaceRegistry)
}
