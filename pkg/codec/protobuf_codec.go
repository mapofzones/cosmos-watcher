...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	...
	comdexRegisterInterfaces(interfaceRegistry)
...
func comdexRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	comdexapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
