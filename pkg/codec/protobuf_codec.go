...
import (
	...
	alteredcarbonapp "github.com/pariah140/alteredcarbon/app"
)

func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	impls := getMessageImplementations()
	interfaceRegistry.RegisterImplementations((*cosmostypes.Msg)(nil), impls...)
	alteredcarbonRegisterInterfaces(interfaceRegistry)
	registerTypes(interfaceRegistry)
}

func alteredcarbonRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	alteredcarbonapp.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
