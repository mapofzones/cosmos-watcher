...
import (
	...
	empowerchain "github.com/EmpowerPlastic/empowerchain/app"
)
...
func RegisterInterfacesAndImpls(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	addressConfig()
	empowerchainRegisterInterfaces(interfaceRegistry)
...
func empowerchainRegisterInterfaces(interfaceRegistry cosmoscodectypes.InterfaceRegistry) {
	empowerchain.ModuleBasics.RegisterInterfaces(interfaceRegistry)
}
...
func registerTypes(interfaceRegistry cosmoscodectypes.InterfaceRegistry) { // todo: need to nest. Maybe we can remove it. Old code
	...
	interfaceRegistry.RegisterImplementations((*ibcexported.ClientMessage)(nil), &ibcclients.ConsensusState{})
