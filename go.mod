...
replace (
	...
	github.com/cosmic-horizon/qwoyn => github.com/cosmic-horizon/QWOYN v1.0.1-0.20230728032542-fa356367ef30
...
require (
	...
	github.com/cosmic-horizon/qwoyn v0.0.0-00010101000000-000000000000 //v5.2.0
