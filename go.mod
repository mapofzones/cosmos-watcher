...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/regen-network/cosmos-sdk v0.46.7-regen-2
...
require (
	...
	github.com/regen-network/regen-ledger/v5 v5.0.0
...
require (
	...
	github.com/regen-network/regen-ledger/x/ecocredit/v3 v3.0.0 // indirect
	github.com/regen-network/regen-ledger/x/intertx v1.0.0 // indirect
