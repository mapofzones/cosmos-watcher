...
replace (
	github.com/CosmWasm/wasmd => github.com/iov-one/starnamed v0.11.6-fix1 // need to use v0.11.6 version, but we have an arror: used for two different module paths
...
require (
	...
	github.com/iov-one/starnamed v0.11.6
...
require (
	...
	github.com/iov-one/cosmos-sdk-crud v0.4.0-rc // indirect
