...
require (
	...
	github.com/osmosis-labs/osmosis/osmomath v0.0.7-0.20231014001935-1946419d44eb // indirect
	github.com/osmosis-labs/osmosis/osmoutils v0.0.7-0.20231011004221-fd24b80f8366 // indirect
