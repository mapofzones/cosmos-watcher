...
replace (
	github.com/CosmWasm/wasmd => github.com/InjectiveLabs/wasmd v0.28.0-inj
	github.com/btcsuite/btcutil => github.com/btcsuite/btcutil v1.0.2
	github.com/cosmos/cosmos-sdk => github.com/InjectiveLabs/cosmos-sdk v0.45.11-inj
...
require (
	...
	github.com/InjectiveLabs/sdk-go v1.44.3 // v1.43.3 also codec configured directly in protobuf_codec.go
