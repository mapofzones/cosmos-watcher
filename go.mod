...
replace (
	github.com/CosmWasm/wasmd => github.com/InjectiveLabs/wasmd v0.27.0-inj
	github.com/btcsuite/btcutil => github.com/btcsuite/btcutil v1.0.2
	github.com/cosmos/cosmos-sdk => github.com/InjectiveLabs/cosmos-sdk v0.45.4-inj
...
require (
	...
	github.com/InjectiveLabs/sdk-go v1.40.2 //also codec configured directly in protobuf_codec.go
