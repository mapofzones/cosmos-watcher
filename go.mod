...
replace github.com/tendermint/spm => github.com/public-awesome/spm v0.1.9-stargaze.0.20211026233752-ed337db721a8
...
require (
	...
	github.com/public-awesome/stargaze v1.0.0
