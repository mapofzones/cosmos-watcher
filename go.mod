...
replace (
	...
	github.com/cosmos/ibc-go => github.com/mapofzones/ibc-go v1.1.0-unmarshal-fix //todo: need to remove if ibc-go >= v2
...
require (
	...
	github.com/pariah140/alteredcarbon v0.0.0-20220105172644-4810696f3ca3
